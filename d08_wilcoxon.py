def compare():
    ...
    while another_comparison == 'Y':
        ...
        compare = stats.wilcoxon(result_1, result_2)

        if compare.statistic == 0 or compare.statistic != compare.statistic:
            ...
            outcome = 'N-gram "{0}" is more common than n-gram "{1}",\n {2} \n(Wilcoxon signed-rank test, p-value = {3})'.format(more_common, 
                                                                                            less_common, 
                                                                                            significance, 
                                                                                            compare.pvalue) 
